...
class CoolDownAnimationScreen extends StatefulWidget {
  final List<ExerciseDataModel> exercises;
  final Map<String, dynamic> userParams;

  const CoolDownAnimationScreen({
    Key? key,
  ...
  @override
  State<CoolDownAnimationScreen> createState() =>
      _CoolDownAnimationScreenState();
}

class _CoolDownAnimationScreenState extends State<CoolDownAnimationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Cool-down Workout", style: TextStyle(color: Colors.white)),
